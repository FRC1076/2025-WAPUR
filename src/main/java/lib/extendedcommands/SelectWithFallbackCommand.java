 ...
 */
public class SelectWithFallbackCommand<K> extends Command {
     ...
     * @param fallback the fallback default command to call if a key isn't found
     * @param selector the selector to determine which command to run
     */
    @SuppressWarnings("this-escape")
    public SelectWithFallbackCommand(Map<K, Command> commands, Command fallback, Supplier<? extends K> selector) {
